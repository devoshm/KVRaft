...
func TestReElection2A(t *testing.T) {
	...
	fmt.Println("First Phase: Leader Fail. Passed.")
	...
	fmt.Println("Second Phase: Leader Reconnects. Passed.")
	...
	fmt.Println("Third Phase: No leaders. Passed.")

	// if a quorum arises, it should elect a leader.
	cfg.connect((leader2 + 1) % servers)
	cfg.checkOneLeader()

	fmt.Println("Fourth Phase: Quorum Passed.")

	// re-join of last node shouldn't prevent leader from existing.
	cfg.connect(leader2)
	cfg.checkOneLeader()

	fmt.Println("Fifth Phase: Failed Leader Reconnects. Passed.")
